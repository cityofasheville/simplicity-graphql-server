-- View: simplicity.budget_summary_by_dept_view

-- DROP VIEW simplicity.budget_summary_by_dept_view;

CREATE OR REPLACE VIEW simplicity.budget_summary_by_dept_view AS
